...
function Player:act_rotRight()
    ...
    if self.cur then
        ...
        -- self.keyPressing[3]=false Commented out to allow IRS
    end
end
function Player:act_rotLeft()
    ...
    if self.cur then
        ...
        -- self.keyPressing[4]=false Commented out to allow IRS
    end
end
function Player:act_rot180()
    ...
    if self.cur then
        ...
        --self.keyPressing[5]=false Commented out to allow IRS
    end
end
...
function Player:act_hold()
    ...
    if self.cur then
        if self:hold() then
            --self.keyPressing[8]=false Commented out to allow IHS
...
function Player:resetBlock()-- Reset Block's position and execute I*S
    ...
    if self.gameEnv.irs then
        ...
        --pressing[3],pressing[4],pressing[5]=false,false,false Commented out to allow IRS
    end
...
function Player:_popNext(ifhold)-- Pop nextQueue to hand
    ...
    if not ifhold and pressing[8] and ENV.ihs and self.holdTime>0 then
        self:hold(true)
        --pressing[8]=false Commented out to allow IHS
    else
        self:resetBlock()
    end
